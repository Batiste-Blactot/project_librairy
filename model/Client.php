...
class Client extends Connexion
{
    ...
    // Fonction qui permet d'afficher les livres empruntés par le client (id client)
    ...
    // Fonction qui permet d'emprunter et à chaque fois d'incrémenter en fonction du nombre d'emprunt 
